		...
		<div class="row mx-0 mt-4 mt-md-0"> 
		    <div class="col-sm-12 col-md-4 col-lg-4">
				...
				<div id="myModal1" class="modal">
				  	<div class="close col-12 d-flex justify-content-end"><img src="img/btnCloseDiv.png" class="img-fluid" onclick="tancaDiv(1,'V');"></div>
				 	<div class="row">	
	    	...
	    	<div class="col-sm-12 col-md-4 col-lg-4">
				...
				<div id="myModal2" class="modal">
				  	<div class="close col-12 d-flex justify-content-end"><img src="img/btnCloseDiv.png" class="img-fluid" onclick="tancaDiv(2,'V');"></div>
				 	<div class="row">	
					  	<div class="col-12 col-md-6 offset-md-3">
					  		<div class="row">
								<div class="col-10 embed-responsive embed-responsive-16by9 mt-4 offset-1 offset-md-0">
			 ...
			 <div class="col-sm-12 col-md-4 col-lg-4">
							...
							<div id="myModal3" class="modal">
							  	<div class="close col-12 d-flex justify-content-end"><img src="img/btnCloseDiv.png" class="img-fluid" onclick="tancaDiv(3,'V');"></div>
							 	<div class="row">	
								  	<div class="col-12 col-md-6 offset-md-3">
								  		<div class="row">
											<div class="col-10 embed-responsive embed-responsive-16by9 mt-4 offset-1 offset-md-0">
						...
						<div class="col-sm-12 col-md-4 col-lg-4">
										...
										<div id="myModal4" class="modal">
										  	<div class="close col-12 d-flex justify-content-end"><img src="img/btnCloseDiv.png" class="img-fluid" onclick="tancaDiv(4,'V');"></div>
										 	<div class="row">	
											  	<div class="col-12 col-md-6 offset-md-3">
											  		<div class="row">
														<div class="col-10 embed-responsive embed-responsive-16by9 mt-4 offset-1 offset-md-0">
									...
									<div class="col-sm-12 col-md-4 col-lg-4">
													...
													<div id="myModal5" class="modal">
													  	<div class="close col-12 d-flex justify-content-end"><img src="img/btnCloseDiv.png" class="img-fluid" onclick="tancaDiv(5,'V');"></div>
													 	<div class="row">	
														  	<div class="col-12 col-md-6 offset-md-3">
														  		<div class="row">
																	<div class="col-10 embed-responsive embed-responsive-16by9 mt-4 offset-1 offset-md-0">
