			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto2.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Rebeca Burgos
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto3.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Mari Cazorla
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto4.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Ana Del Campo
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto5.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Sara Garcimartín
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto6.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Belén Garrido
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
									Qualsevol dona pot ser una guerrera, una Santa Jordina. És igual el color de pell que tinguis, si ets més alta, més baixa, rossa o bruna.
								</span>
								<span class="ES textWhite">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto7.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Rosa Gilibert
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
			...
			<div class="row">
				...
				<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
					<div class="row">
						...
						<!-- TODO: copy -->
						<div class="col-12 col-lg-12 d-flex align-items-end">
							<img src="img/cartells/cartellFoto8.png" class="img-fluid "><span class="textWhite">&nbsp;&nbsp;&nbsp;Pol Viñas
						</div>
						<div class="col-12 col-lg-12 mt-lg-4">
							<p>
								<span class="CA textWhite">
