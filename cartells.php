<?php include("inc/head.php");?>
	<div class="row">
		...
		<div class="col offset-1 d-none d-sm-block txtTitles text-center mx-2">
			<h1>
				<span class="CA">
					Els cartells	
				</span>
	...
	<div class="row mx-0">
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell1.png" class="img-fluid" onclick="agrandaDiv(1);"> </div>
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell2.png" class="img-fluid" onclick="agrandaDiv(2);"> </div>
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell3.png" class="img-fluid" onclick="agrandaDiv(3);"> </div>
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell4.png" class="img-fluid" onclick="agrandaDiv(4);"> </div>
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell5.png" class="img-fluid" onclick="agrandaDiv(5);"> </div>
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell6.png" class="img-fluid" onclick="agrandaDiv(6);"> </div>
						...
						<div class="col-12 col-lg-12 mt-lg-4 textWhite">
							<p>
								<span class="CA textWhite">
									...
									si ets més alta, més baixa, rossa o bruna.
								</span>
								<span class="ES textWhite">
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell7.png" class="img-fluid" onclick="agrandaDiv(7);"> </div>
					...
					<div class="col-12 col-lg-4 mt-lg-4 ml-lg-3">
						...
						<div class="col-12 col-lg-12 mt-lg-4 textWhite">
							<p>
								...
								<span class="ES textWhite">
									Mi intención desde un principio fue salir de la monotonía de lo que representa Sant Jordi y demostrar el aprecio que le tengo a Barcelona. El mar está inspirado con el estilo tan característico de Gaudí, el Trencadís. La cola de dragón y la luna están hechos con plastilina. El mar, el skyline de Barcelona y el cielo están hechos con Illustrator.
								</span>
							</p>
						</div>
					</div>	
		...
		<div class="col-12 col-md-4 col-lg-3">
			<div class="col-md-8 text-center offset-md-2"> <img src="img/cartells/cartell8.png" class="img-fluid" onclick="agrandaDiv(8);"> </div>
