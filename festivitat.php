<?php include("inc/head.php");?>
		<div class="row">		
			<div class="col-6"><br/> <div class= "txtTitles text-center d-none d-sm-block">La festivitat al carrer</div><img src="img/santJordiCarrer_lg.png" class="col-12 img-fluid"></div>
			<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6" id="txtfestivitat">  
				...
				<br/>
					<p>
						...
						Que no faltin tampoc les sardanes, els castellers, les exposicions... 
						A Catalunya, el dia dels enamorats el consideren aquest dia, mentre que a la resta d'Espanya el consideren el 14 de febrer. 
						Aquest dia vol recordar el dia de la mort del cavaller Jordi. 
						El sant, que restava sota les ordres de l’emperador Dioclecià, es va negar a seguir l’ordre de perseguir els cristians, per la qual cosa el van matar. 
		...
		<div class="row">		
			<div class=" col-sm-6  col-md-6 col-lg-6 col-xl-6 " id="txtescoles">
					...
					<p>
						...
						Que no falti el concurs literari que es fa, els nens i nenes creen el seu propi poema o la seva història que presenten. 
						Els 3 millors relats de cada categoria que més agraden són premiats amb un llibre i una rosa. 
			...
			<div class=" col-6  "><div class= "txtTitles text-center d-none d-sm-block">La festivitat a les escoles</div><img src="img/santJordiEscola_lg.png" class="col-12 img-fluid" > </div>
	</div>	
<br/>
