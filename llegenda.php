<?php include("inc/head.php");?>
	<div class="row row-eq-height row1">
		<div class="col-12 col-md-6 col-lg-6 mt-4 order-2 order-md-0"><div class="txtTitles text-center d-none d-sm-block">La llegenda de Sant Jordi</div>
			<div class="separation"></div>
			<div class="text-center"><img src="img/llegenda_divider_lg.png" class="col-sm-12 col-md-6 col-lg-6 img-fluid"></div>
			<div class="separation"></div>
			<p class="txtBorders"><span class="firstcharacter">C</span>onta la llegenda que Sant Jordi era un soldat romà nascut al Pròxim Orient i és el gran protagonista d'una gran gesta cavalleresca que se situa a Líbia. Tot i això, certa tradició catalana la creu esdevinguda a la població de Montblanc.<br><br>
