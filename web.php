...
<div class="row">
	...
	<div class="col-lg-8 offset-lg-2 mb-5 ">
		<div>
			<a href=""><img class="img-fluid borderRound  mt-2 mb-1" src="img/fotoEnGrupoPaint.jpg"></a>
		</div>
...
<div class="row">
	...
	<div class="row">	
		...
		<p>
			Per començar el projecte, tots els components del grup ens vam reunir per fer una pluja d’idees o brainstorming. Dins d’aquesta primera part es plantegen les característiques de la pàgina web que volem crear, des de la seva finalitat (explicar la llegenda de Sant Jordi, la festivitat, etc) fins a la quantitat d’informació que volem afegir (imatges, textos, etc). Més tart ens repartim els apartats establerts de la página.
		</p>
	</div>
