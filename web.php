...
<div class="row">
	...
	<div class="col-lg-8 offset-lg-2 mb-5">
		<a href="#movimientoDiv"><img class="img-fluid borderRound" src="img/fotoGrupo.jpg"></a>		<p class="text-center ml-3 mr-3 mt-2"><span class="CA" style="display:none;">Hello world! Som <b>el Rafat, l’Andrea, el Raúl, la Raquel, l’Oscar, el Santi, la Clàudia i la Alix</b>, els creadors d’aquesta pàgina web. Formem part de l'especialitat de desenvolupament d'app i web apps, dins del projecte de Treballs als barris de la Casa d’Oficis de Barcelona Activa.</span><span class="ES" style="display:none;">Hello world! Somos  <b>Rafat, Andrea, Raúl, Raquel, Oscar, Santi, Clàudia y Alix</b>, los creadores de esta página web. Formamos parte de la especialidad de desarrollo de app y web apps, dentro del proyecto de Treballs als barris de la Casa d’Oficis de Barcelona Activa.</span></p>
	</div>
