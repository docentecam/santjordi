...
<div class="row">
	...
	<div class="col-lg-8 offset-lg-2 mb-5 ">
		...
		<h5 class="text-center ml-3 mr-3"><span class="CA">Hello world! Som el Rafat, <b>l’Andrea, el Raúl, la Raquel, l’Oscar, el Santi, la Clàudia i l'Alix</b>, els creadors d’aquesta pàgina web. Formem part de l'especialitat de desenvolupament d'app i web apps, dins del projecte de Treballs als barris de la Casa d’Oficis de Barcelona Activa.</h5></span><h5><span class="ES">Hello world! Somos  <b>Rafat, Andrea, Raúl, Raquel, Oscar, Santi, Clàudia y Alix</b>, los creadores de esta página web. Formamos parte de la especialidad de desarrollo de app y web apps, dentro del proyecto de Treballs als barris de la Casa d’Oficis de Barcelona Activa.</span></h5>
	</div>
...
<div id=desgWeb2 class="row mostraDiv">
	...
	<div class="col-12 d-none d-sm-block txtTitles text-center ">
			<h1>Creació de la estructura</h1>
	</div>
<div class="row">
...
<div id="desgWeb4" class="row mostraDiv">
		...
		<div class="col-12 d-none d-sm-block txtTitles text-center ">
			<h1>Finalització del projecte</h1>
		</div>
	<div class="row">	
