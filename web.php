...
<div class="row">
	<div class="col-12 col-md-12 card mb-3">
...
<div class="row">
	<div  class="col-sm-12  col-lg-6 ">
		 <img id="meetingImage" class="img-fluid" src="img/reunionpaint.jpg">
	</div>	
...
<div class="row">
	<div class="text-dark mb-3 col-sm-12 col-md-12 col-lg-6 mt-5" >
	  ...
	  <div>
	    <h5 id="textFirezila" ">Un cop acabat el projecte, mitjançant el filezila pujem els arxius finalitzats al hosting que aixo fa que qualsevol persona entri a la pàgina.	
	     </h5>
				  
	  </div>
	</div>
	<div class="col-sm-12 col-md-12 col-lg-6">
		<img id="pictureFilezila" class="img-fluid" src="img/sitioFilezilla.png">
	</div>
...
<div class="row">
	<div  class="col-sm-12 col-md-12 col-lg-6 mb-5">
	 ...
	 <div  class="col-sm-12 col-md-12 col-lg-6 mt-5 text-center">
		 <div>
		    <h5 id="textWeb"> Finalment aquí teniu la pàgina ja pujada al hosting.	
		     </h5>
		    <div>
