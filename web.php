...
<div class="row mx-0 mt-4 mt-md-0">
	...
	<div class="col-lg-8 offset-lg-2 mb-5 ">
		...
		<p class="text-center ml-3 mr-3 mt-2"><span class="CA" style="display:none;">Hello world! Som <b>el Rafat, l’Andrea, el Raúl, la Raquel, l’Oscar, el Santi, la Clàudia i l'Alix</b>, els creadors d’aquesta pàgina web. Formem part de l'especialitat de Desenvolupament d'aplicacions Web i WebApp's, dins del projecte Casa d’Oficis Barris Digtals de Treballs als Barris de Barcelona Activa.</span><span class="ES" style="display:none;">Hello world! Somos  <b>Rafat, Andrea, Raúl, Raquel, Oscar, Santi, Clàudia y Alix</b>, los creadores de esta página web. Formamos parte de la especialidad de Desarrollo de aplicaciones Wbpp y WebApp's, dentro del proyecto  Casa d’Oficis Barris Digitals de Treballs als Barris de Barcelona Activa.</span></p>
	</div>
	<div class="row">
		...
		<div class="col-10 col-lg-6 offset-1 offset-lg-3 text-center textWhite order-1 order-md-0 mt-4 mt-md-0">
			<p>
				...
				<span class="ES" style="display:none;">
					Para empezar el proyecto, todos los componentes del grupo nos reunimos para hacer una lluvia de ideas o brainstorming. Dentro de esta primera parte se plantean las características de la página web que queremos crear, desde su finalidad (explicar la leyenda de Sant Jordi, la festividad, etc) hasta la cantidad de información que queremos añadir (imágenes, textos, etc). Más tarde nos repartimos los apartados establecidos de la página.
				</span>
			</p>
			<p>
				<span class="CA" style="display:none;">
					No obstant ens dividim cada apartat de la pàgina entre els integrants del grup amb el fi de desenvolupar individualment el lloc web. Tenint en compte les mides de cada imatge, gif, i vídeos animats implementats en aquesta pàgina que seran creats per les altres especialitats digitals. Tot això sobretot amb cohesió de grup.
				</span>
			
				<span class="ES" style="display:none;">
					No obstante nos dividimos cada apartado de la página entre los integrantes del grupo con el fin de desarrollar individualmente el sitio web. Teniendo en cuenta las medidas de cada imagen, gif, y vídeos animados implementados en esta página que serán creados por las otras especialidades digitales. Todo esto sobretodo con cohesión de grupo.
				</span>
			</p>
		</div>
		...
		<div id="textoFinal" class="col-10 col-lg-6 offset-1 offset-lg-3 text-center textWhite order-1 order-md-0 mt-4 mt-md-0">
			<div>
				<p>
					...
					<span class="ES" style="display:none;">
						Después de muchas semanas de trabajo, llega el momento de colgar la web a internet. Para hacerlo, usamos el programa Filezilla, que permite que nos conectamos a un servidor web. A través de este programa, colgamos los archivos y el código que forman la web al hosting, es decir, a un servicio de almacenamiento online. Este paso nos permite acceder en la web en cualquier momento a través de internet.
					</span>
				</p>
			</div>
		</div>
